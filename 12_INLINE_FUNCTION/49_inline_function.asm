; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	D:\PRATHAMESH\POLYMORPHISM\49_inline_function.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	?Fun6@@YAXXZ					; Fun6
PUBLIC	?Fun5@@YAXXZ					; Fun5
PUBLIC	?Fun4@demo@@QAEXXZ				; demo::Fun4
PUBLIC	?Fun3@demo@@QAEXXZ				; demo::Fun3
PUBLIC	?Fun2@demo@@QAEXXZ				; demo::Fun2
PUBLIC	?Fun1@demo@@QAEXXZ				; demo::Fun1
PUBLIC	_main
...
; Function compile flags: /Odtp
_TEXT	ENDS
;	COMDAT ?Fun1@demo@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
_iNo1$ = -4						; size = 4
?Fun1@demo@@QAEXXZ PROC					; demo::Fun1, COMDAT
; _this$ = ecx
; Line 7
	push	ebp
	mov	ebp, esp
...
; Line 8
	mov	DWORD PTR _iNo1$[ebp], 10		; 0000000aH
; Line 9
	mov	esp, ebp
	pop	ebp
	ret	0
?Fun1@demo@@QAEXXZ ENDP					; demo::Fun1
; Function compile flags: /Odtp
_TEXT	ENDS
;	COMDAT ?Fun2@demo@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
_iNo1$ = -4						; size = 4
?Fun2@demo@@QAEXXZ PROC					; demo::Fun2, COMDAT
; _this$ = ecx
; Line 12
	push	ebp
	mov	ebp, esp
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 13
	mov	DWORD PTR _iNo1$[ebp], 20		; 00000014H
; Line 14
	mov	esp, ebp
	pop	ebp
	ret	0
?Fun2@demo@@QAEXXZ ENDP					; demo::Fun2
; Function compile flags: /Odtp
_TEXT	ENDS
_TEXT	SEGMENT
_this$ = -8						; size = 4
_iNo1$ = -4						; size = 4
?Fun3@demo@@QAEXXZ PROC					; demo::Fun3
; _this$ = ecx
; Line 43
	push	ebp
	mov	ebp, esp
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 44
	mov	DWORD PTR _iNo1$[ebp], 30		; 0000001eH
; Line 45
	mov	esp, ebp
	pop	ebp
	ret	0
?Fun3@demo@@QAEXXZ ENDP					; demo::Fun3
; Function compile flags: /Odtp
_TEXT	ENDS
;	COMDAT ?Fun4@demo@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
_iNo1$ = -4						; size = 4
?Fun4@demo@@QAEXXZ PROC					; demo::Fun4, COMDAT
; _this$ = ecx
; Line 47
	push	ebp
	mov	ebp, esp
	...
	mov	DWORD PTR _this$[ebp], ecx
; Line 48
	mov	DWORD PTR _iNo1$[ebp], 40		; 00000028H
; Line 49
	mov	esp, ebp
	pop	ebp
	ret	0
?Fun4@demo@@QAEXXZ ENDP					; demo::Fun4
; Function compile flags: /Odtp
_TEXT	ENDS
_TEXT	SEGMENT
_iNo1$ = -4						; size = 4
?Fun5@@YAXXZ PROC					; Fun5
; Line 52
	push	ebp
	mov	ebp, esp
	push	ecx
; Line 53
	mov	DWORD PTR _iNo1$[ebp], 50		; 00000032H
; Line 54
	mov	esp, ebp
	pop	ebp
	ret	0
?Fun5@@YAXXZ ENDP					; Fun5
; Function compile flags: /Odtp
_TEXT	ENDS
;	COMDAT ?Fun6@@YAXXZ
_TEXT	SEGMENT
_iNo1$ = -4						; size = 4
?Fun6@@YAXXZ PROC					; Fun6, COMDAT
; Line 56
	push	ebp
	mov	ebp, esp
	push	ecx
; Line 57
	mov	DWORD PTR _iNo1$[ebp], 60		; 0000003cH
; Line 58
	mov	esp, ebp
	pop	ebp
	ret	0
?Fun6@@YAXXZ ENDP					; Fun6
_TEXT	ENDS
END
